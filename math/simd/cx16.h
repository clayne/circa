typedef circa_std_or_gnu(struct { T V0; T V1; T V2; T V3; T V4; T V5; T V6; T V7; T V8; T V9; T V10; T V11; T V12; T V13; T V14; T V15; }, T) C2(T, x16) circa_if_gnu(__attribute__((vector_size(16 * sizeof(T)))));
